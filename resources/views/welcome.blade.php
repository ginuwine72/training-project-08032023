...
.bgimg-1 {
  ...
  background-image: url("https://api.time.com/wp-content/uploads/2016/04/hp-spectre-13-3_aerial-view.jpg?quality=85&w=800");
  min-height: 100%;
}
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="/cont" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i> CONTACT</a>
    </div>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px">
  <div class="w3-row-padding">
    ...
    <div class="w3-col m6">
      <img class="w3-image w3-round-large" src="https://www.nobbot.com/wp-content/uploads/2017/03/apple-device-1853354_1920.jpg" alt="Buildings" width="700" height="394">
    </div>
  </div>
</div>
...
<h3 class="w3-center">OUR Product</h3>
  <p class="w3-center w3-large">What we sell for people</p>
